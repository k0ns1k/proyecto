<template>
    <div>
        ...
        <ResponsiveSidebar
            v-if="authentication.is_authenticated"
            :teams="teams"
        />

        <StaticSidebar v-if="authentication.is_authenticated" :teams="teams" />
...
onMounted(async () => {
    if (authentication.is_authenticated) {
        client.axios().defaults.headers.common["Authorization"] =
            `Bearer ${authentication.token.access_token}`;
