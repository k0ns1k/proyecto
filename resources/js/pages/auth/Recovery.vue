<template>
    <div class="mx-auto max-w-lg">
        <div class="shadow-lg border rounded-lg p-6">
            <form class="space-y-6" @submit.prevent="authentication.do_recovery">
                <div>
                    <label for="email"
                           :class="[authentication.recovery.invalid('email') ? 'text-red-900' : 'text-gray-900']"
                    ...
                    <div class="mt-2">
                        <input id="email"
                               ...
                               autocomplete="email"
                               :class="[authentication.recovery.invalid('email') ? 'text-red-900 ring-red-300 placeholder:text-red-400 focus:ring-red-600' : 'text-gray-900 ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600']"
                ...
                <div>
                    <button :disabled="authentication.recovery.processing"
