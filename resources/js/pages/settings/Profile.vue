<template>
  ...
  >
    <div class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
      ...
      <form
        class="md:col-span-2"
        @submit.prevent="authentication.do_change_profile"
      >
          ...
          <div class="col-span-full flex items-center gap-x-8">
            ...
            <div>
              <input
                ...
                type="file"
                name="photo"
                @change="(e) => { authentication.change_profile.photo = e.target.files[0] }"
              >
        ...
        <div class="mt-8 flex">
          <button
            :disabled="authentication.change_profile.processing"
